                        ...
                        >
                            <div className="flex flex-col lg:flex-row gap-8 items-start">
                                ...
                                <div className="w-full lg:w-48 space-y-4">
                                    ...
                                    >
                                        <img
                                            src={`http://194.238.18.10:8001${reward.review_screenshot}`}
                ...
                {showImageModal && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/95 backdrop-blur-xl transition-all" onClick={() => setShowImageModal(false)}>
                        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="relative max-w-5xl w-full h-full flex flex-col justify-center items-center gap-8" onClick={e => e.stopPropagation()}>
                            <img src={`http://194.238.18.10:8001${selectedImage}`} className="max-w-full max-h-[80vh] rounded-[2rem] shadow-[0_0_100px_rgba(59,130,246,0.1)] border border-white/10" />
                            <div className="flex gap-4">
                                <a href={`http://194.238.18.10:8001${selectedImage}`} download className="p-4 bg-white/5 hover:bg-white/10 text-white rounded-2xl border border-white/5 transition-all"><Download size={20} /></a>
                                <a href={`http://194.238.18.10:8001${selectedImage}`} target="_blank" className="p-4 bg-white/5 hover:bg-white/10 text-white rounded-2xl border border-white/5 transition-all"><ExternalLink size={20} /></a>
